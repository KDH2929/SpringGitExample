...
public class BoardController {
	...
	public String getListByCategory(@PathVariable("categoryId") int categoryId, HttpSession session, Model model) {
	...
	public String getBoardDetails(@PathVariable("boardId") int boardId, Model model) {
		return getBoardDetails(boardId, 1, model);
	}

	@GetMapping(value = "/board/write/{categoryId}")
	public String writeArticle(@PathVariable("categoryId") int categoryId, HttpSession session, Model model) {
		// CSRF 토큰 생성 후 세션에 저장
	...
	public String replyArticle(@PathVariable("boardId") int boardId, Model model) {
		Board board = boardService.selectArticle(boardId);
		board.setWriter("");
		board.setEmail("");
	...
	public ResponseEntity<byte[]> getFile(@PathVariable("fileId") int fileId) {
	...
	public String updateArticle(@PathVariable("boardId") int boardId, Model model) {
		List<BoardCategory> categoryList = categoryService.selectAllCategory();
		Board board = boardService.selectArticle(boardId);
		model.addAttribute("categoryList", categoryList);
		model.addAttribute("categoryId", board.getCategoryId());
	...
	public String deleteArticle(@PathVariable("boardId") int boardId, Model model) {
